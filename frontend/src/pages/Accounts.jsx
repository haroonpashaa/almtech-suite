...
export default function Accounts() {
  ...
  return (
    <div>
      ...
      />
      <div className="p-6 sm:p-8 space-y-4 max-w-[1200px]">
        ...
        <Table
          ...
          columns={[
            ...
            { key: 'openingBalance', label: 'Opening', className: 'text-right num text-ink-500', render: (a) => money(a.openingBalance, currency) },
            {
              key: 'currentBalance',
      ...
      <Modal open={showAdd} onClose={() => setShowAdd(false)} title="New Financial Account">
        <div className="space-y-3">
          <div>
            ...
            <input className="input" value={form.name} onChange={(e) => set('name', e.target.value)} placeholder="e.g. Meezan Bank" />
          </div>
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input className="input num" type="number" step="0.01" value={form.openingBalance} onChange={(e) => set('openingBalance', e.target.value)} />
            </div>
          </div>
          {form.type !== 'cash' && (
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input className="input font-mono" value={form.accountNumber} onChange={(e) => set('accountNumber', e.target.value)} />
              </div>
            </div>
          )}
          <div className="flex gap-2 pt-2">
            <button className="btn-primary-gradient" onClick={save} disabled={saving || !form.name.trim()}>
